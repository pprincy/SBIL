...
@IonicPage()
@Component({
  selector: 'page-mpin-set',
  templateUrl: 'mpin-set.html',
})
export class MpinSetPage {
      ...
      this.restapiProvider.sendRestApiRequest(requestUpdateProfile, 'updateProfile')
        .subscribe((response) => {
          ...
          if (response.IsSuccess == true) {
            this.setMPinStep = '3';
            this.myApp.updatePageUseCount("46");
            this.utilitiesProvider.googleAnalyticsTrackView('PinSet');
